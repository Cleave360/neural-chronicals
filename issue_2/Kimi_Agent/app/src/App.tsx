    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'glass' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="font-display font-bold text-xl gradient-text">NEURAL CHRONICLE</div>
    ...
    <section className="py-20 bg-charcoal">
      <div className="max-w-4xl mx-auto px-6">
        <div className="glass rounded-2xl p-8 md:p-12 border border-electric-purple/20">
          ...
          <h2 className="font-display font-bold text-3xl text-white mb-6">Welcome to the Neural Chronicle</h2>
          ...
          <div className="space-y-4 text-gray-300 leading-relaxed">
            ...
            <p>
              That&apos;s why we created the Neural Chronicle. Each month, we&apos;ll bring you the stories that matter: 
        ...
        <div className="mt-20 text-center">
          <div className="glass rounded-2xl p-8 md:p-12 border border-electric-purple/20 inline-block max-w-2xl">
            ...
            <p className="text-gray-400 mb-6">
              Get the Neural Chronicle delivered to your inbox every month. 
    ...
    <footer className="py-16 bg-void border-t border-electric-purple/20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center">
          <h2 className="font-display font-black text-4xl gradient-text mb-4">NEURAL CHRONICLE</h2>
          ...
          <p className="text-sm text-gray-600">
            © 2026 Neural Chronicle. All rights reserved.
          </p>
